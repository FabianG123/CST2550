...
public:
    Book(int _bookID, const std::string& _bookName, int _pageCount, const std::string& _authorFirstName, const std::string& _authorLastName, const std::string& _bookType)
        : bookID(_bookID), bookName(_bookName), pageCount(_pageCount), authorFirstName(_authorFirstName), authorLastName(_authorLastName), bookType(_bookType) {
    }
...
Book books[] = {
    ...
    {5, "Pharaohs, Fellahs and Explorers", 367, "Amelia B.", "Edwards", "Guide"},
    ...
    {11, "A pushcart at the curb", 95, "John", "DosPassos", "Science fiction"},
    ...
    {16, "A Touch of Sun and Other Stories", 141, "Mary Hallock", "Foote", "Guide"},
    ...
    {21, "Short Stories From American History", 305, "Albert", "Blaisdell", "Health"},
    {22, "Mrs Rosie and the Priest", 104, "Givoanni", "Boccaccio", "Biographies"},
    {23, "So Big", 209, "Edna", "Ferber", "Drama"},
    {24, "Monsieur Maurice", 92, "Amelia B.", "Edwards", "Health"},
    {25, "The Master of Ballantrae", 236, "Robert Louis", "Stevenson", "Journals"},
    {26, "The Unlived Life of Little Mary Ellen", 99, "Ruth", "Stuart", "Mystery"},
    ...
    {32, "A Hazard of New Fortunes", 144, "William Dean", "Howells", "Action and Adventure"},
    ...
    {46, "A Tagore Reader", 285, "Rabindranath", "Tagore", "Action and Adventure"},
    ...
    {53, "Fairy Prince and Other Stories", 306, "Eleanor Hallowell", "Abbott", "Fantasy"},
    {54, "Ten Tales from the Decameron", 183, "Givoanni", "Boccaccio", "Romance"},
    ...
    {61, "My Life Had Stood a Loaded Gun", 278, "Emily", "Dickinson", "Diaries"},
    ...
    {70, "A Sleep and a Forgetting", 360, "William Dean", "Howells", "Satire"},
    {71, "Nicholas Nickleby", 219, "Charles", "Dickens", "Science fiction"},
    {72, "The Whole Family: A Novel by Twelve Authors", 149, "William Dean", "Howells", "Mystery"},
    {73, "Middlemarch", 288, "George", "Eliot", "Comics"},
    {74, "Life of Dante", 156, "Givoanni", "Boccaccio", "Biographies"},
    {75, "Short Stories From English History", 189, "Albert", "Blaisdell", "Satire"},
    {76, "Little Eve Edgarton", 306, "Eleanor Hallowell", "Abbott", "Romance"},
    ...
    {83, "The Decameron: Selected Tales", 337, "Givoanni", "Boccaccio", "Science"},
    ...
    {88, "Collected Stories", 295, "Rabindranath", "Tagore", "Action and Adventure"},
    ...
    {93, "Little Eve Edgarton", 247, "Eleanor Hallowell", "Abbott", "Biographies"},
    ...
    {97, "The Great God Pan And The Hill Of Dreams", 158, "Arthur", "Machen", "Romance"},
    {98, "The White People and Other Weird Stories", 100, "Arthur", "Machen", "Fantasy"},
    {99, "The Diary of Samuel Pepys: A Selection", 271, "Samuel", "Pepys", "Drama"},
    {100, "The Rise of Silas Lapham", 314, "William Dean", "Howells", "Satire"},
    {101, "The Mystery of Edwin Drood", 340, "Charles", "Dickens", "Diaries"},
    {102, "In Exile and Other Stories", 140, "Mary Hallock", "Foote", "Comics"},
    ...
    {107, "Heroic Deeds of American Sailors", 243, "Albert", "Blaisdell", "Science fiction"},
    ...
    {117, "Selected Poems", 203, "Emily", "Dickinson", "Guide"},
        {118, "Gobolinks or Shadow Pictures for Young and Old", 332, "Ruth", "Stuart", "Romance"},
    {119, "The Decameron", 318, "Givoanni", "Boccaccio", "Diaries"},
    {120, "The Cock and Anchor", 133, "Joseph Sheridan", "LeFanu", "Science fiction"},
    ...
    {124, "Treasure Island", 308, "Robert Louis", "Stevenson", "Action and Adventure"},
    ...
    {128, "The Story of Babette: A Little Creole Girl", 313, "Ruth", "Stuart", "Romance"},
    ...
    {133, "Molly Make-Believe", 286, "Eleanor Hallowell", "Abbott", "Diaries"},
    {134, "Peace on Earth, Good Will to Dogs", 321, "Eleanor Hallowell", "Abbott", "Guide"},
    ...
    {138, "The Elegy of Lady Fiammetta", 157, "Givoanni", "Boccaccio", "Action and Adventure"},
    ...
    {144, "Fairy Prince and Other Wonderful Stories", 219, "Eleanor Hallowell", "Abbott", "Science fiction"},
    {145, "Adam Bede", 303, "George", "Eliot", "Action and Adventure"},
    {146, "Madam Crowl's ghost", 344, "Joseph Sheridan", "LeFanu", "Journals"},
    ...
    {156, "The White Linen Nurse", 369, "Eleanor Hallowell", "Abbott", "Journals"},
    ...
    {163, "Book Of Indian Braves", 117, "Kate Dickinson", "Sweetser", "Health"},
    {164, "Binodini", 306, "Rabindranath", "Tagore", "Health"},
    {165, "Holly And Pizen, And Other Stories", 220, "Ruth", "Stuart", "Science"},
    ...
    // Example of accessing book details
    for (const auto& book : books) {
        ...
        std::cout << "Book Type: " << book.getBookType() << std::endl;
        std::cout << "-------------------------" << std::endl;
    }
